# -*- coding: utf-8 -*-
"""
Created on Mon Aug 10 17:58:32 2020
...
ax_voltaje = fig.add_axes([0.1,0.72,0.21,0.12], ylabel = "$Voltage(V)$", xlabel = "$Tiempo (s)$")
...
ax_corriente = fig.add_axes([0.592,0.72,0.21,0.12], ylabel = "$Corriente(A)$", xlabel = "$Tiempo (s)$")
plt.subplots_adjust(left=0.15, bottom=0.55)
...
axpolar_voltajes.set_title("Fasores", pad = 5)
...
axpolarv1.set_title("S. Positiva", pad = 5)
...
axpolarv2.set_title("S. Negativa", pad = 5)
...
axpolarv3.set_title("S. Cero", pad = 5)
...
axpolar_corrientes.set_title("Fasores", pad = 5)
...
axpolari1.set_title("S. Positiva", pad = 5)
...
axpolari2.set_title("S. Negativa", pad = 5)
...
axpolari3.set_title("S. Cero", pad = 5)
...
sphase_i1 = Slider(axphase_i1, 'Phase_ia', -180, 180, valinit=fase_corriente, color ="blue")
srms_i1 = Slider(axrms_i1, 'rms_ia', 0, 100, valinit=i_rms, color ="blue")

sphase_i2 = Slider(axphase_i2, 'Phase_ib', -180, 180, valinit=-120 + fase_corriente, color ="green")
srms_i2 = Slider(axrms_i2, 'rms_ib', 0, 100, valinit=i_rms, color = "green")

sphase_i3 = Slider(axphase_i3, 'Phase_ic', -180, 180, valinit=120 + fase_corriente, color = "red")
srms_i3 = Slider(axrms_i3, 'rms_ic', 0, 100, valinit=i_rms, color = "red")
...
texto = fig.text(0.6,0.08,"Potencia activa (P): " + str(round(valores[0],3)) + " kW\nPotencia reactiva (Q): " + str(round(valores[1],3)) + " kVAR\nPotencia aparente aritmética (Sa): " + str(round(valores[2],3)) + " kVA\nPotencia aparente vectorial (Sv): " + str(round(valores[3],3)) + " kVA\nPotencia aparente eficaz (Se): " + str(round(valores[4],3))
                 + " kVA\nFactor de potencia aritmético: " + str(round(tf.calcula_potencias(v1,v2,v3,i1,i2,i3)[3],3)) + "\nFactor de potencia vectorial: " + str(round(tf.calcula_potencias(v1,v2,v3,i1,i2,i3)[5],3))
                 + "\nFactor de potencia eficaz: " + str(round(tf.calcula_potencias(v1,v2,v3,i1,i2,i3)[7],3)) + 
                 "\nPotencia de desequilibrio: " + str(round(tf.calcula_potencias(v1,v2,v3,i1,i2,i3)[8]/1000,3)) + " kVA")
texto_corriente = fig.text(0.1,0.88,"Sistema trifásico (voltajes de fase)", fontsize = 15)
texto_voltajes = fig.text(0.61,0.88,"Sistema trifásico (corrientes de línea)", fontsize = 15)
...
def update(val):
    ...
    texto.set_text("Potencia activa (P): " + str(round(valores[0],3)) + " kW\nPotencia reactiva (Q): " + str(round(valores[1],3)) + " kVAR\nPotencia aparente aritmética (Sa): " + str(round(valores[2],3)) + " kVA\nPotencia aparente vectorial (Sv): " + str(round(valores[3],3)) + " kVA\nPotencia aparente eficaz (Se): " + str(round(valores[4],3))
                 + " kVA\nFactor de potencia aritmético: " + str(round(tf.calcula_potencias(v1,v2,v3,i1,i2,i3)[3],3)) + "\nFactor de potencia vectorial: " + str(round(tf.calcula_potencias(v1,v2,v3,i1,i2,i3)[5],3))
                 + "\nFactor de potencia eficaz: " + str(round(tf.calcula_potencias(v1,v2,v3,i1,i2,i3)[7],3)) + 
                 "\nPotencia de desequilibrio: " + str(round(tf.calcula_potencias(v1,v2,v3,i1,i2,i3)[8]/1000,3)) + " kVA")
